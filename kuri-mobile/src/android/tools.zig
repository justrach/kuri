...
pub const all = [_]Tool{
    ...
    .{
        .name = "state",
        .aliases = &.{"snapshot"},
        .summary = "foreground app, screen size and every actionable element — one call",
        .category = "observe",
        .scope = .both,
    },
    .{
        .name = "notifications",
        .flags = &.{"--open"},
        .summary = "read posted notifications (--open pulls the shade down instead)",
        .category = "observe",
        .scope = .both,
    },
    .{
        .name = "find",
        .flags = &.{ "--label", "--id", "--class", "--desc", "--index", "--interactive" },
        .summary = "print elements matching a selector, with tap-ready centroids",
        .category = "observe",
        .scope = .both,
    },
    .{
    ...
    .{
        ...
        .args = "<x> <y>",
        .flags = &.{ "--label", "--id", "--class", "--desc", "--index", "--interactive" },
        .summary = "tap a point, or the element a selector resolves to",
        .category = "input",
        .scope = .both,
    },
    .{
    ...
    .{
        ...
        .args = "<text...>",
        .flags = &.{"--clear"},
        .summary = "type text into the focused field (--clear replaces its contents)",
        .category = "input",
        .scope = .both,
    },
    .{
        .name = "wait",
        .args = "<milliseconds>",
        .summary = "sleep — for the animation `wait-for-ui` cannot express",
        .category = "input",
        .scope = .both,
    },
    .{
